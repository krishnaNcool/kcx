 ...
 */
package org.kcx.core.constants;

/**
 * Global class for all KcxCore constants. You can add global constants for your extension into this class.
 */
public final class KcxCoreConstants extends GeneratedKcxCoreConstants
{
	public static final String EXTENSIONNAME = "kcxcore";


	private KcxCoreConstants()
	{
		//empty
	}

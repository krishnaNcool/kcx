 ...
 */
package org.kcx.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(KcxFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(KcxFulfilmentProcessConstants.PARENT_PROCESS);

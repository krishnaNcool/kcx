...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/kcxstorefront/electronics/en",
						"https://electronics.local:9002/kcxstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/kcxstorefront/electronics/en",
						"https://electronics.local:9002/kcxstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/kcxstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/kcxstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/kcxstorefront/electronics/en",
						"https://electronics.local:9002/kcxstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/kcxstorefront",
						"https://electronics.local:9002/kcxstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/kcxstorefront",
						"https://electronics.local:9002/kcxstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/kcxstorefront/electronics/en",
						"https://electronics.local:9002/kcxstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}

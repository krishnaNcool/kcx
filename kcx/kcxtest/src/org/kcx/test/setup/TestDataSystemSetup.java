...
import org.kcx.test.constants.KcxTestConstants;
import org.kcx.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = KcxTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/kcxtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/kcxtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/kcxtest/import/cstickets.impex");
			...
			importImpexFile(context, "/kcxtest/import/csquotes.impex");
		}
	}
}
